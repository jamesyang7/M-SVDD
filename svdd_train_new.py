...
from nets.svdd_net import FusionNet_new
...
use_attention = 1
Epoch = 40
save_name = "DSVDD_new_{}".format(use_attention)
...
model = FusionNet_new(use_crossattention=use_attention, feature_dim=feature_dim, dropout_rate=dropout_rate, kernel_num=kernel_num, classes=num_class)
...
# random_tensor = torch.load('/home/iot/collision_detect/svdd/center_2.pth')
best_val_loss = float('inf')
best_model_state_dict = None

torch.save(random_tensor, 'center_new.pth')
# print(random_tensor)
