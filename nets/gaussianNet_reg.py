...
class GaussianSVDDModel(nn.Module):
    def __init__(self, output_dim=128,feature_dim=256, confidence=0.95, reg_const=1e-3,is_train=1):
...
class Trainer:
    ...
    def train(self, num_epochs, log_interval=5):
        ...
        for epoch in range(num_epochs):
            ...
            for i, data in enumerate(self.train_loader, 0):
                ...
                # # Total loss
                total_loss = gaussian_loss+reg_loss
    ...
    def compute_entropy_and_covariance_loss(self, z):
        ...
        diagonal_weight = 1
        condition_weight = 1
        total_loss = diagonal_weight * diagonal_penalty + condition_weight * condition_number_penalty
