...
checkpoint_path = '/home/iot/collision_detect/output/vae_baseline/svdd_0_/best_model.pth'
...
with torch.no_grad():
    for sample_idx in range(len(val_data)):
        ...
        svdd_loss = loss_function(features, target_zero) * 1000
