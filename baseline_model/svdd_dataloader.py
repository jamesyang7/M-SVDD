...
# x = CollisionLoader('/home/iot/audio_visual_collision/Data')
# a,b,c,d = x.__getitem__(0)


class CollisionLoader_new(Dataset):
    def __init__(self,imu_path ,audio_path ,frequency=[0,10000],train=True):
...
# x = CollisionLoader_new('../../data/imu','../../data/audio')
# a,b,c = x.__getitem__(0)